...
==================================
@Author Andrei Rusu
@Author Eugen Robert Patrascu
==================================

The Paragon Interpreter was implemented using OCaml 4.02.3.
It allows the interpretation of programs written in Paragon, a domain specific programming language.
...
command mentioned above: "./mysplinterpreter myprogram.spl"
